                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="header__top__right">
                            ...
                            <div style="padding-left: 15px;" class="header__top__right__auth">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="{{ route('shoppage') }}">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="{{route('shopdetails')}}">Shop Details</a></li>
                                    <li><a href="#">Shoping Cart</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="breadcrumb__text">
                                <h2>@yield('breadcumb')</h2>
                                <div class="breadcrumb__option">
                                    <a href="#">Home</a>
                                    <span>@yield('breadcumb')</span>
                                </div>
                            </div>
                        </div>
                    </div>
